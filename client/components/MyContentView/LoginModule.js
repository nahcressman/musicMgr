...
let LoginModule = ( {loggedIn, onLogoutClick} ) => {
	if(!loggedIn) {
		return (
			<div>
				<a href="https://accounts.spotify.com/authorize/?client_id=2068662022c74a1697dcc0e4eeacf439&response_type=code&redirect_uri=http://localhost:3000/loggedIn&scope=playlist-modify-public%20user-read-private%20playlist-read-collaborative%20playlist-read-private&show_dialog=true" >
